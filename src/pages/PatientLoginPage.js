    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.data.token) {
                ...
                const patientData = { ...response.data.patient, role: 'patient' };

                dispatch(setUser(patientData));
                ...
                Swal.fire({
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            try {
                                await axiosInstance.post('/patients/resend-verification', { email });
                                Swal.fire({
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleLogin} className="grid grid-cols-1 sm:grid-cols-1 gap-4 md:gap-6">
                            ...
                            <div className="flex items-center justify-between">
                                <Link to="/patient/forgot-password" className="text-sm font-medium text-primary-600 hover:underline">
                                    Forgot password?
                                </Link>
                            </div>
                            <button
